...
const ALLOWED_ORIGINS = ['https://www.usetooleasy.com', 'https://usetooleasy.com'];
  ...
  try {
    ...
    if (!response) {
      response = await fetch(targetUrl, {
        headers: {
          'User-Agent': 'ToolEasy-WASM-Proxy/1.0',
          Accept: '*/*',
        },
      });
