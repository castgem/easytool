...
Host ToolEasy using Apache HTTP Server.
...
```bash
sudo mkdir -p /var/www/tooleasy
sudo cp -r dist/* /var/www/tooleasy/
sudo chown -R www-data:www-data /var/www/tooleasy
```

## Step 3: Apache Configuration

Create `/etc/apache2/sites-available/tooleasy.conf`:
...
<VirtualHost *:443>
    ServerName your-domain.com
    DocumentRoot /var/www/tooleasy

    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/your-domain.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/your-domain.com/privkey.pem

    <Directory /var/www/tooleasy>
...
Create `/var/www/tooleasy/.htaccess`:
...
```bash
sudo chown -R www-data:www-data /var/www/tooleasy
sudo chmod -R 755 /var/www/tooleasy
```
