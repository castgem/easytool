...
const SITE_URL = 'https://www.usetooleasy.com'

export default defineConfig({
    title: "ToolEasy Docs",
    description: "Documentation for ToolEasy — privacy-first online toolkit",
    base: '/docs/',
    cleanUrls: true,
    ...
    themeConfig: {
        ...
        footer: {
            message: '© ToolEasy. All rights reserved.',
            copyright: 'Copyright © 2026 ToolEasy'
        },
