...
<p align="center"><strong>唤星易用</strong> — 中文品牌名</p>

# ToolEasy

**ToolEasy**（中文名 **唤星易用**，usetooleasy.com）is an **AI-agent-callable** online toolkit: 100+ privacy-first tools in the browser — starting with PDF, plus JSON, Base64, hashing, and more — with an **MCP server** for Cursor, Claude, and custom agents.
