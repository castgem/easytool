...
const baseCategories = [
  {
    ...
    tools: [
      {
        href: import.meta.env.BASE_URL + 'json-formatter.html',
        name: 'JSON Formatter',
        icon: 'ph-brackets-curly',
        subtitle: 'Validate, pretty-print, or minify JSON in your browser.',
      },
      {
        href: import.meta.env.BASE_URL + 'base64-tool.html',
        name: 'Base64 Tool',
        icon: 'ph-binary',
        subtitle: 'Encode and decode UTF-8 text to Base64.',
      },
      {
        href: import.meta.env.BASE_URL + 'hash-generator.html',
        name: 'Hash Generator',
        icon: 'ph-fingerprint',
        subtitle: 'Compute SHA-256 hashes locally — no upload.',
      },
    ],
  },
  {
