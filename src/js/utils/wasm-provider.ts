...
const STORAGE_KEY = 'tooleasy:wasm-providers';

const CDN_DEFAULTS: Record<WasmPackage, string> = {
  pymupdf: 'https://cdn.jsdelivr.net/npm/@tooleasy/pymupdf-wasm@0.11.16/',
  ghostscript: 'https://cdn.jsdelivr.net/npm/@tooleasy/gs-wasm@0.1.1/assets/',
  ...
  modal.innerHTML = `
    <div class="p-6">
      ...
      <p class="text-xs text-gray-500 mb-4">
        This module is provided by a third party and is subject to its own license terms. By configuring it, you agree to those terms.
      </p>
    </div>
