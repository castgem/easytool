/*
 * coherentpdf.global.d.ts — TypeScript type definitions for ToolEasy / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the ToolEasy project.
